...
class Post extends Model
{
    ...
    protected $fillable=['post_parent_id','title','tags','summary','slug','description','photo','quote','post_cat_id','post_tag_id','added_by','status','lang','seo_meta_title','seo_meta_description','seo_meta_tag'];
