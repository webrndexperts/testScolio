...
class TestOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		$ccEmail = ['drkevinlau@scoliolife.com' , 'webrndexperts@gmail.com', 'jagpreetrnd@yahoo.com' , 'srdev.rndexperts@gmail.com' ,'webdev20222@gmail.com' ,'shibashishmohapatra1@gmail.com'];
		
		try {
			//code...
			$admin_sent_mail = Mail::to('shibashishoo007@gmail.com')->send(new OrderEMail($order_information_mail));
			// $admin_sent_mail = Mail::to('clinic.sg@scoliolife.com')->cc($ccEmail)->send(new OrderEMail($order_information_mail));
