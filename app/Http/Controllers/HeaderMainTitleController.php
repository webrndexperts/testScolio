...
class HeaderMainTitleController extends Controller
{
     /**
    ...
    {
        $xrayresultsCategories=HeaderMainTitle::orderBy('id','DESC')->paginate(10);
		//dd($xrayresultsCategories);
        return view('backend.headermain-title-category.index')->with('xrayresultsCategories',$xrayresultsCategories);
    }
    ...
    public function create()
    {
        ...
        return view('backend.headermain-title-category.create')->with('languages',$languages);
    }
    ...
    public function store(Request $request)
    {
        ...
        $count=HeaderMainTitle::where('slug',$slug)->count();
        if($count>0){
        ...
        foreach ($dataDes as $postData) {
            ...
            $status = HeaderMainTitle::create($postData);
        }	
        ...
        return redirect()->route('header-main-title.index');
    }
    ...
    {
        $xrayCategory=HeaderMainTitle::findOrFail($id);
        return view('backend.headermain-title-category.edit')->with('xrayCategory',$xrayCategory);
    }
    ...
    {
        $postCategory=HeaderMainTitle::findOrFail($id);
         // return $request->all();
