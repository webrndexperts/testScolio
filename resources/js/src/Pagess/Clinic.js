...
function Clinic() {
    ...
    const getImageData = (language) => {
        switch (language) {
            case 'en_SG':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-EN.png',
            ...
            case 'es_ES':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-ES.png',
            ...
            case 'fr_FR':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-FR.png',
            ...
            case 'id_ID':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-ID.png',
            ...
            case 'it_IT':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-IT.png',
            ...
            case 'es_MX':
                ...
                case 'de_DE':
                    return {
                        imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-DE.png',
            ...
            case 'zh_CN':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-CS.png',
            ...
            case 'zh_HK':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-CT.png',
            ...
            case 'ja_JP':
                return {
                    imageUrl: 'https://scoliolife.com/uploads/2023/08/Clinic-Tour-JP.png',
                    ...
                    <div className='about'>
                        <div>
                            <div className="elementor-widget-container">
                                <img loading="lazy" alt="" decoding="async"  src={imageUrl} />
                            </div>
