...
const ContactComponent = (props) => {
    ...
    const triggerSubmission = async (data) => {
        ...
        formData.append(
            "subscribe",
            typeof data.subscribe != "	undefined" ? "yes" : "no"
        );
        formData.append("file", "");
        formData.append("recaptcha", captchaToken);
        // debugger
                ...
                <div className="form-design">
                    <div className="row">
                        <div className={`col-md-${col}`}>
                            ...
                            {icons && (
                                <span className="icon-form-home">
                                    <img src={FormUser} alt="form-user" />
                                </span>
                            )}

                            {errors.name && (
                                <p className="validations">
                                    {t("form.Please enter your name")}
                                </p>
                            )}
                        </div>
                        ...
                        <div className={`col-md-${col}`}>
                            ...
                            {icons && (
                                <span className="icon-form-home">
                                    <img src={FormEmail} alt="form-email" />
                                </span>
                            )}
                            ...
                            {errors.email_address &&
                                errors.email_address.type == "required" && (
                                    <p className="validations">
                                        {t("form.Please enter your email")}
                                    </p>
                                )}
                            {errors.email_address &&
                                errors.email_address.type == "pattern" && (
                                    <p className="validations">
                                        {t("form.error.emailType")}
                                    </p>
                                )}
                        </div>
                        ...
                        <div className={`col-md-${col2}`}>
                            ...
                            {icons && (
                                <span className="icon-form-home">
                                    <img src={FormNumber} alt="form-number" />
                                </span>
                            )}
                            ...
                            {errors.phone_number &&
                                errors.phone_number.type == "required" && (
                                    <p className="validations">
                                        {t(
                                            "form.Please enter your phone number"
                                        )}
                                    </p>
                                )}
                            {errors.phone_number &&
                                errors.phone_number.type == "pattern" && (
                                    <p className="validations">
                                        {t("form.error.phoneType")}
                                    </p>
                                )}
                            {errors.phone_number &&
                                errors.phone_number.type == "minLength" && (
                                    <p className="validations">
                                        {t("form.error.phoneMinLength")}
                                    </p>
                                )}
                        </div>
                        ...
                        <div className={`col-md-${col2}`}>
                            ...
                            {icons && (
                                <span className="icon-form-home">
                                    <img src={FormCountry} alt="form-country" />
                                </span>
                            )}

                            {errors.country && (
                                <p className="validations">
                                    {t("form.Please enter your country")}
                                </p>
                            )}
                        </div>
                            ...
                            {multiple ? (
                                <Fragment>
                                    {files.map((file, index) => (
                                        <div
                                            className="extra-files form-group"
                                            key={index}
                                        >
                                            <AppendField
                                                key={file.id}
