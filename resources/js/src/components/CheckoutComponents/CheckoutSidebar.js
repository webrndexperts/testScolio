    ...
    return (
        <div className="col-md-6 input-all">
            <div className="all-data">
                            ...
                            <div className="blA7b">
                                ...
                                <div className="product-nam">
                                    ...
                                    {item.attriuteCustomized ? (
                                        <div className="size-nam">
                                            Report: {item.attriuteCustomized}
                                        </div>
                                    ) : null}
                ...
                {couponMsg ? (
                    <span className="text-success">{couponMsg}</span>
                ) : null}

                <div className="discount-code-nam">
                    <form
                        className="discount-form"
                        onSubmit={handlecoupon(applyCouponCode)}
                    >
                        <input
                ...
                {couponDetail ? (
                    <div className="subtotal-nam Coupon_data">
                        <p>
                            {t("CART12.Coupon")} -{" "}
                            <span className="discount_coupon">
                                {couponDetail?.data?.coupon_name}{" "}
                            </span>
                            <span
                                className="remove-coupon text-danger"
                ...
                <div className="subtotal-nam">
                    <p>{t("CART12.Tax")}</p>
                    <h5 className="all-price-add">
                        ${parseFloat(taxPrice).toFixed(2)} SGD
                    </h5>
                </div>
                ...
                <div className="subtotal-nam total_p">
                    <p>{t("CART12.Total")}</p>
                    <h5 className="all-price-add">
                        ${parseFloat(totalPrice).toFixed(2)} SGD
                    </h5>
                </div>
