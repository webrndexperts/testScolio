  ...
  useEffect(() => {
    if (
      ...
      let itemDataWithLanguage = {
        ...
        price: tool == true ? itemData.price : itemData.price + 55,
      };
              ...
              <div className="product-listing">
                ...
                <div className="product-listing-sidebar-main">
                  <div className="product-listing-sidebar">
                    ...
                    {(!CheckLogin || (initialPosts.length && !initialPosts[0]?.order && !initialPosts[0]?.order?.id)) && (
