        ...
        fetch(`${API}products/filter/${currentLanguage}${params}`)
            ...
            .then((data) => {
                ...
                let _metaProps = {
                    ...
                    title:
                        data && data.seo_meta_title ? data.seo_meta_title : "",
                    description:
                        data && data.seo_meta_description
                        ...
                        {shopData && (
                            <div className="Sort-By-Categories">
                                <select
                                    ...
                                    onChange={sortByCategories}
                                >
                                    <option value="Sort By Order">
                                        {" "}
                                        {t("product.Sort_By_Order")}
                                    </option>
                                    <option value="Sort by latest">
                                        {t("product.Sort_by_latest")}
                                    </option>
                                ...
                                <p className="shotting-result">
                                    {t("product.show_results").replace(
                                        "??",
                                        shopData?.length
                                    )}
                                </p>
                            ...
                            shopData?.map((userData) => (
                                <div key={userData.id} className="col-sm-4">
                                    <div className="shop-treatments">
                                        ...
                                        <Link
                                            to={`${urlLanguage}/product/${userData.slug}`}
                                            onClick={() => scrollToTop()}
                                        >
                                                            ...
                                                            <>
                                                                ...
                                                                "en_MY" ? (
                                                                    <Link
                                                                        ...
                                                                        to="https://calendar.google.com/calendar/u/0/appointments/AcZssZ2TqAIY5UIPxzP-EDaEkKISdkTf2qniUQmsIQw="
                                                                        target="_blank"
                                                                    >
                                                                        {t(
                                                                            "top-header.Book Consultation"
                                                                        )}
                                                                    </Link>
                                                                ) : (
                                                                    <Link
