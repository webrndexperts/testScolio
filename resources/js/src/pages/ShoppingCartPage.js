...
// import MyTotal from "../components/CartComponents/MyTotal";
...
const ShoppingCartPage = () => {
  ...
  useEffect(() => {
    console.log("Clearing shipping localStorage due to language change:", currentLanguage);
    localStorage.removeItem("checkAddressSelect");
    localStorage.removeItem("shippingData");
    // localStorage.removeItem("shippingCartAddress");
  }, [currentLanguage]);
            ...
            {cart.length === 0 ? (
              <div className="entry-content rnd-test">
                <div className="woocommerce">
                  ...
                  <p className="return-to-shop">
                    <Link className="button wc-backward" to={`${urlLanguage}/shop`}>
                      {t("CART12.Return to shop")}
                    </Link>
                  </p>
                </div>
