...
<div class="card">
    <h5 class="card-header">Add Sub Main Title </h5>
    <div class="card-body">
      <form method="post" action="{{route('header-submenu-title.store')}}">
        {{csrf_field()}}
		<input type="hidden" name="header_type"  value="Header-SubMenu-title" class="form-control">
