      ...
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <textarea class="form-control description" id="description" name="description">{{$coupon->description}}</textarea>
        </div> 
		...
		<div class="form-group">
            ...
            <input id="inputTitle" type="date" name="expiry_date"  value="{{$coupon->expiry_date}}" class="form-control">
        </div> 
