...
Route::prefix('v1')->group(function () {
    ...
    Route::get('online-booking-url', function () {
        $contents = File::get(resource_path('jsons/online-booking.json'));
...
*/
    ...
    Route::get('disclaimer/filter/{language}', [WidgetsApiController::class, 'filterByLanguageDisclaimerWidget']);
